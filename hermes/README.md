...
| profile | description |
|---|---|
| `anim-app-maint` | anim-app-maint: maintainer bot for kotoba-lang/kami-engine-animation (kami-engine-animation): health scan, CI red detection, propose-only PRs, 30min cron |
